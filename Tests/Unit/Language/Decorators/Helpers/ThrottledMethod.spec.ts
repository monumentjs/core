import {ThrottledMethod} from '../../../../../Source/Language/Decorators/Helpers/ThrottledMethod';


describe('ThrottledMethod', () => {
    const TEST_ARGUMENTS = [1, 2, 3];

    let method: ThrottledMethod;
    ...
    describe('#constructor(method, delay[, leading, trailing, maxWait])', () => {
        it('create new instance with only 2 arguments specified', () => {
            ...
            expect(() => {
                method = new ThrottledMethod(fn, 100);
            }).not.toThrow();
        });
    });
        ...
        describe('suppress too rapidly method calls', () => {
            ...
            it('leading', () => {
                return new Promise((resolve, reject) => {
                    ...
                    method = new ThrottledMethod(fn, 100, true, false);
                    method.call(null, TEST_ARGUMENTS);
                    method.call({}, TEST_ARGUMENTS);
                    method.call([], TEST_ARGUMENTS);
            ...
            it('leading and trailing', () => {
                return new Promise((resolve, reject) => {
                    ...
                    method = new ThrottledMethod(fn, 100, true, true);
                    method.call(null, TEST_ARGUMENTS);
                    method.call({}, TEST_ARGUMENTS);
                    method.call([], TEST_ARGUMENTS);
        ...
        describe.skip('force call after max wait time exceeded', () => {
            it('trailing', () => {
                return new Promise((resolve, reject) => {
                    ...
                    method = new ThrottledMethod(fn, 100, false, true, 200);
