...
export interface UnitPostProcessor {
     ...
     */
    postProcessBeforeInitialization<T extends object>(instance: T, unitType: Type<T>): Promise<T>;
     ...
     */
    postProcessAfterInitialization<T extends object>(instance: T, unitType: Type<T>): Promise<T>;
}
