  ...
  describe('ReadOnlyMultiValueMap', function() {
    ...
    describe('keys', function() {
      it('should return set of keys', function() {
        const source: ReadOnlyMultiValueMap<string, string> = create([['name', 'Alex'], ['name', 'Dmitri'], ['email', 'test@mail.com']]);
    ...
    describe('containsEntries()', function() {
      it('should determines whether map contains all key-value pairs', function() {
        const map: ReadOnlyMultiValueMap<string, string> = create([['name', 'Alex'], ['name', 'Dmitri'], ['email', 'test@mail.com']]);
