...
export class ImmutableArrayList<T> extends ReadOnlyCollectionBase<T> implements ImmutableList<T>, Cloneable<ImmutableArrayList<T>> {
  ...
  addIfAbsent(item: T, comparator: Func2<T, T, boolean> = StrictEquals): ImmutableList<T> {
    const copy: ImmutableArrayList<T> = this.clone();
  ...
  remove(item: T, comparator: Func2<T, T, boolean> = StrictEquals): ImmutableList<T> {
    const copy: ImmutableArrayList<T> = this.clone();
  ...
  removeAll(items: Iterable<T>, comparator: Func2<T, T, boolean> = StrictEquals): ImmutableList<T> {
    const copy: ImmutableArrayList<T> = this.clone();
  ...
  retainAll(items: Iterable<T>, comparator: Func2<T, T, boolean> = StrictEquals): ImmutableList<T> {
    const copy: ImmutableArrayList<T> = this.clone();
