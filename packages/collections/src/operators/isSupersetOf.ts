...
export function isSupersetOf<T>(self: Iterable<T>, other: Iterable<T>): boolean;
export function isSupersetOf<T>(self: Iterable<T>, other: Iterable<T>, equals: Delegate<[T, T], boolean>): boolean;
