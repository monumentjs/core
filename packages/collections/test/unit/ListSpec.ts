...
export abstract class ListSpec extends CollectionSpec {
    ...
    @Test
    public 'indexOf() finds index of given item using custom equality comparator'(assert: Assert) {
        let list: List<string> = this.create(['one', 'two']);

        assert.equals(list.indexOf('ONE'), -1);
        assert.equals(list.indexOf('ONE', 0, list.length, IgnoreCaseComparator.instance), 0);
        assert.equals(list.indexOf('ONE', 1, list.length - 1, IgnoreCaseComparator.instance), -1);
        assert.equals(list.indexOf('THREE', 0, list.length, IgnoreCaseComparator.instance), -1);
    }
    ...
    @Test
    public 'lastIndexOf() finds index of given item using custom equality comparator'(assert: Assert) {
        let list: List<string> = this.create(['one', 'two']);

        assert.equals(list.lastIndexOf('ONE'), -1);
        assert.equals(list.lastIndexOf('ONE', 0, 1, IgnoreCaseComparator.instance), 0);
        assert.equals(list.lastIndexOf('ONE', 1, 1, IgnoreCaseComparator.instance), -1);
        assert.equals(list.lastIndexOf('THREE', 0, 1, IgnoreCaseComparator.instance), -1);
    }
    ...
    @Test
    public 'groupBy() returns list of grouped items using custom comparator'(assert: Assert) {
    ...
    @Test
    public 'except() returns list without specified items using custom comparator'(assert: Assert) {
        let list: List<string> = this.create(['two', 'ONE', 'one', 'Three', 'One']);
        let filteredList: List<string> = list.except(this.create(['one', 'Five']), IgnoreCaseComparator.instance);
    ...
    @Test
    public 'intersect() returns list without specified items using custom comparator'(assert: Assert) {
        let list: List<string> = this.create(['two', 'ONE', 'one', 'Three', 'One']);
        let filteredList: List<string> = list.intersect(this.create(['one', 'Five']), IgnoreCaseComparator.instance);
    ...
    @Test
    public 'join() joins lists using custom equality comparator'(assert: Assert) {
    ...
    @Test
    public 'orderBy() returns sorted list using ascending sort order'(assert: Assert) {
        ...
        }, IgnoreCaseComparator.instance, SortOrder.ASCENDING);
    ...
    @Test
    public 'orderBy() returns sorted list using descending sort order'(assert: Assert) {
        let originalList: List<string> = this.create(['two', 'ONE', 'one', 'Three', 'One']);
        let orderedList: List<string> = originalList.orderBy((word: string): string => {
            return word.slice(0, 2);
        }, IgnoreCaseComparator.instance, SortOrder.DESCENDING);
    ...
    @Test
    public 'orderBy() returns sorted list using custom no sort order'(assert: Assert) {
        let originalList: List<string> = this.create(['two', 'ONE', 'one', 'Three', 'One']);
        let orderedList: List<string> = originalList.orderBy((word: string): string => {
            return word.slice(0, 2);
        }, IgnoreCaseComparator.instance, SortOrder.NONE);
