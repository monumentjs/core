...
export class LocaleEquivalentMaps {

    public static readonly singleEquivMap: Map<string, string> = (() => {
        // This is an auto-generated file and should not be manually edited.
        //   LSR Revision: 2013-09-23
        let singleEquivMap: Map<string, string> = new ListMap();
        ...
        return singleEquivMap;
    })();

    public static readonly multiEquivsMap: Map<string, string[]> = (() => {
        let multiEquivsMap: Map<string, string[]> = new ListMap();

        multiEquivsMap.put('ccq', ['rki', 'ybd']);
        multiEquivsMap.put('cmn', ['zh-guoyu', 'zh-cmn']);
        multiEquivsMap.put('drw', ['prs', 'tnf']);
        multiEquivsMap.put('hak', ['i-hak', 'zh-hakka']);
        multiEquivsMap.put('i-hak', ['hak', 'zh-hakka']);
        multiEquivsMap.put('mry', ['mst', 'myt']);
        multiEquivsMap.put('mst', ['mry', 'myt']);
        multiEquivsMap.put('myt', ['mry', 'mst']);
        multiEquivsMap.put('prs', ['drw', 'tnf']);
        multiEquivsMap.put('rki', ['ccq', 'ybd']);
        multiEquivsMap.put('tnf', ['prs', 'drw']);
        multiEquivsMap.put('ybd', ['rki', 'ccq']);
        multiEquivsMap.put('zh-cmn', ['cmn', 'zh-guoyu']);
        multiEquivsMap.put('zh-guoyu', ['cmn', 'zh-cmn']);
        multiEquivsMap.put('zh-hakka', ['hak', 'i-hak']);

        return multiEquivsMap;
    })();

    public static readonly regionVariantEquivMap: Map<string, string> = (() => {
        let regionVariantEquivMap: Map<string, string> = new ListMap();
