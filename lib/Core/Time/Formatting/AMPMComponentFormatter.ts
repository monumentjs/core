...
export default class AMPMComponentFormatter extends TimeComponentFormatterBase {
    public static readonly instance: AMPMComponentFormatter = new AMPMComponentFormatter();
