...
export default class SecondsComponentFormatter extends TimeComponentFormatterBase {
    public static readonly instance: SecondsComponentFormatter = new SecondsComponentFormatter();
